...
class CellularEnv(Env):
    ...
    def step(self, action):
        ...
        self.reward_rate[index2] = 1-np.exp(-aux_arr[index2])
        ...
        # DQN 16.2 ---------------------------------------------------------------------------------------------
        #if sum(self.Tx_power) == 0 or sumrate == 0:
        #    self.reward_rate = np.ones(self.Nbs) * -100
        #else:
        #    self.reward_rate = np.ones(self.Nbs) * (sumrate / (10*np.log10(1000*sum(self.Tx_power))))
        # DQN 16.2 ---------------------------------------------------------------------------------------------
        ...
        return self.state, self.reward_rate, done, info, sumrate, EE, sum(self.Tx_power)
